...
mst(document).ready(function($) {
    ...
    $('.menu-creator-pro-responsive .fa-caret-right').removeClass("fa-caret-right").addClass("fa-caret-down");
    ...
    $('.menu-creator-pro-responsive > li:not(.parent) .fa-caret-down').remove();
    $('.menu-creator-pro-responsive > li .fa-caret-down').addClass("icon_toggle")
    $('.menu-creator-pro-responsive > li .icon_toggle').click(function(){
        ...
        if($(this).hasClass("fa-caret-down")){
            $(this).removeClass('fa-caret-down').addClass('fa-caret-up').next().slideDown(500);
        }else{
            $(this).removeClass('fa-caret-up').addClass('fa-caret-down').next().slideUp(500);
        };
    });
    $('.menu-creator-pro .fa-caret-down').click(function(){
