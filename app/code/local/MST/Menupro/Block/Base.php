...
class MST_Menupro_Block_Base extends Mage_Core_Block_Template {
	protected $_plus = '<span class="mcp-icon fa-caret-plus-square expand"></span>';
	...
	*/
	...
	public function getAccoridionAutoSubMenuUl($parentCategoryId, $autosub)
	{
		$html = $this->getAutoSubMenuUl(
			...
			'<span class="mcp-icon fa-caret-plus-square expand"></span>'
		);
		return $html;
	}
	//If menu have sub
	...
	*/
	...
	public function getArrow($position) {
		$data = array(
			'menu-creator-pro' => '<span class="mcp-icon fa-caret-down"></span>',
			'menu-creator-pro menu-creator-pro-top-fixed' => '<span class="mcp-icon fa-caret-down"></span>',
			'menu-creator-pro menu-creator-pro-left' => '<span class="mcp-icon fa-caret-right"></span>',
			'menu-creator-pro menu-creator-pro-left-fixed' => '<span class="mcp-icon fa-caret-right"></span>',
			'menu-creator-pro menu-creator-pro-right' => '<span class="mcp-icon fa-caret-left"></span>',
			'menu-creator-pro menu-creator-pro-right-fixed' => '<span class="mcp-icon fa-caret-left"></span>',
			'menu-creator-pro menu-creator-pro-bottom' => '<span class="mcp-icon fa-caret-up"></span>',
			'menu-creator-pro menu-creator-pro-bottom-fixed' => '<span class="mcp-icon fa-caret-up"></span>',
			'menu-creator-pro menu-creator-pro-accordion' => '<span class="mcp-icon fa-caret-down"></span>',
		);
